...
$cf_al_by_sms=$conf->global->CF_AL_BY_SMS;
...
$url = 'https://dolimail.fr/server/api/'.$conf->global->API_VERSION.'/active.php';
$fields = array(
	...
	$Form.='
		<script>
			$(document).ready(function() {
				$("#pro").click(function() {
					window.open("https://dolimail.fr/offre.php?apikey='.$conf->global->DOLIMAIL_APIKEY.'", "_blank");
